...
pro.set = function(prop, value){
    ...
    this[prop] = value;
    if(this.type == consts.ENTITY_TYPE.PLAYER){
        this.emit(EVENTS.UPDATE_PROP, prop, value, this);
    }
    else if(this.type == consts.ENTITY_TYPE.ROOM){
        this.emit(EVENTS.UPDATE_ROOMPROP, prop, value, this);
    }
    else if(this.type == consts.ENTITY_TYPE.SEAT){
        this.emit(EVENTS.UPDATE_SEATPROP, prop, value, this);
    }
};
